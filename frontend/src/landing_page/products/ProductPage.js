  ...
  return (
    <>
      ...
      <LeftSection
        ...
        productName="Coin"
        productDescription="Buy direct mutual funds online, commission-free, delivered directly to your 
      ...
      <RightSection
        ...
        HTTP/JSON APIs. If you are a startup, build your investment app and showcase it to our 
        clientbase."
        learnMore=""
      />
      <LeftSection
      ...
      <p className="text-center fs-4 m-5">
        ...
        <a style={{textDecoration:"none"}} href="https://zerodha.tech">Zerodha.tech </a>
        blog.
      </p>
      <Universe />
    </>
