    ...
    <footer className="bg-light mt-5">
      <div className="container border-top mt-5 ">
        <div className="row mt-5">
          ...
          <div className="col ">
            <p className="mb-3" style={{fontWeight: "bold",fontSize: "24px"}}>Account</p>
            <a
              href=""
          ...
          <div className="col">
            <p className="mb-3" style={{fontWeight: "bold",fontSize: "24px"}}>Support</p>
            <a
              href=""
               className="footer-link text-muted"
              style={{ color: "black" }}
          ...
          <div className="col">
            <p className="mb-3" style={{fontWeight: "bold",fontSize: "24px"}}>Company</p>
            <a
              href=""
              className="footer-link text-muted"
              style={{ color: "black" }}
          ...
          <div className="col">
            <p className="mb-3" style={{fontWeight: "bold",fontSize: "24px"}}>Quick links</p>
            <a
              href=""
              className="footer-link text-muted"
              style={{ color: "black" }}
